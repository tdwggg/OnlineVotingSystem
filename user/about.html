    ...
    <main class="userMain userPageMotion">
        <section class="aboutHero userCard">
            <div>
                ...
                <p>
                    A secure online voting prototype designed for voter registration, schedule-based voting,
                    ballot submission, admin monitoring, election results, and Power BI visualization.
                </p>
            </div>

            <span class="aboutHeroBadge">
        ...
        <section class="aboutGrid">
            <div class="sectionCard userCard">
                <div class="sectionHeader">
                    <div>
                        ...
                        <p>
                            iVotePH is a web-based voting system prototype built to simulate a secure, organized,
                ...
                <p class="aboutText">
                    The system is designed around a verified voter ID database. A voter can register only if their
                    voter ID already exists in the official list. After registration, the voter can log in using their
                    voter ID and password, review candidates, and submit one ballot during the official voting schedule.
                </p>

                <div class="aboutList">
                    <div class="aboutListItem">
                        <div class="aboutListIcon">
                            <i class="fa-solid fa-id-card"></i>
                        </div>

                        <div>
                            <h4>Voter ID-based registration</h4>
                            <p>
                                The database starts with eligible voter IDs only. A profile becomes complete after the user registers.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="aboutListItem">
                        ...
                        <div>
                            <h4>Admin-controlled voting schedule</h4>
                            <p>
                                Voting opens and closes based on the schedule configured in the admin panel.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="aboutListItem">
                        ...
                        <div>
                            <h4>Dashboard and Power BI support</h4>
                            <p>
                                Aggregated voting data can be visualized in the admin panel and later embedded using Power BI.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <aside class="sectionCard userCard">
                ...
                <div class="aboutStatStack">
                    <div class="aboutStat">
                        <span>Login Method</span>
                        <strong>Voter ID + Password</strong>
                    </div>
                    ...
                    <div class="aboutStat">
                        ...
                        <strong>Schedule-based voting</strong>
                    </div>
        ...
        <section class="sectionCard userCard">
            <div class="sectionHeader">
                <div>
                    <h2>Core Features</h2>
                    <p>
                        These are the main functions that define the purpose of the iVotePH prototype.
                    </p>
                </div>
            </div>
            ...
            <div class="infoGrid">
                <div class="featureCard">
                    ...
                    <h4>Secure</h4>
                    <p class="text-muted">
                        Protects voter identity, account access, and ballot integrity.
                    </p>
                </div>
                ...
                <div class="featureCard">
                    ...
                    <h4>Scheduled</h4>
                    <p class="text-muted">
                        Follows the election schedule set by the admin panel.
                    </p>
                </div>
                ...
                <div class="featureCard">
                    ...
                    <h4>Data-driven</h4>
                    <p class="text-muted">
                        Supports admin charts, election monitoring, and Power BI dashboard embedding.
                    </p>
                </div>
            </div>
        </section>
